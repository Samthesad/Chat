...
function sendMessage(){
  if(name==="?"){let belowName = document.getElementById("belowName") 
  belowName.innerHTML = "Please specify name."}
  else if(document.getElementById("messageBox").value===""){document.getElementById("belowMessage").innerHTML = "Please enter a valid message."}
  else{let msg = document.getElementById("messageBox").value;
  let full = {name,msg}
